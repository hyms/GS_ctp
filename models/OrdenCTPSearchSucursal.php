 ...
 */
class OrdenCTPSearchSucursal extends OrdenCTP
{
    ...
    public function rules()
    {
        return [
            ...
            [['fechaGenerada', 'fechaCobro', 'fechaPlazo', 'codigoServicio', 'autorizado', 'observaciones', 'observacionesCaja', 'responsable', 'telefono', 'observacionAdicional', 'factura', 'codDependiente','nombreUsuario','nombreSucursal'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->joinWith('fkIdSucursal');
        $query->andFilterWhere(['like','nombre',$this->nombreSucursal]);
