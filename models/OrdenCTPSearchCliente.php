 ...
 */
class OrdenCTPSearchCliente extends OrdenCTP
{
    ...
    public function rules()
    {
        return [
            ...
            [['fechaGenerada', 'fechaCobro', 'fechaPlazo', 'codigoServicio', 'autorizado', 'observaciones', 'observacionesCaja', 'responsable', 'telefono', 'observacionAdicional', 'factura', 'codDependiente','nombreCliente'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->joinWith('fkIdCliente');
        $query->andFilterWhere(['like','nombreNegocio',$this->nombreCliente]);
