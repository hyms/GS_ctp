...
class numerosALetras extends Component
{
	/*
	...
	*/
	function decenas($decena)
	{
		$valores = array('cero', 'uno', 'dos', 'tres', 'cuatro', 'cinco', 'seis', 'siete',
			...
			100 => 'cientos', 101 => 'quinientos', 102 => 'setecientos', 103 => 'novecientos');
	...
	*/
    ...
    function mostrar()
    {
        if (is_numeric($this->valor)) {
            return ucwords(strtolower($this->convertir($this->valor)));
        } else
