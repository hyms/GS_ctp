    ...
    <div class="row">
        <div class="col-xs-4">
            ...
            <?=
                Carousel::widget([
                        'items' => [
                            '<div class="text-center">'.Html::img(Yii::$app->request->baseUrl.'/images/CTP1.jpeg',['style'=>'with:360px; height: 260px']).'</div>',
                            '<div class="text-center">'.Html::img(Yii::$app->request->baseUrl.'/images/CTP2.jpeg',['style'=>'with:360px; height: 260px']).'</div>',
                            '<div class="text-center">'.Html::img(Yii::$app->request->baseUrl.'/images/CTP3.jpeg',['style'=>'with:360px; height: 260px']).'</div>',
                        ],
                ]);
            ?>
        </div>
